...
OPTION_PRICER_URL=${DLP_FRONTEND_OPTION_PRICER_URL:-/option-pricer}
OPTION_PRICER_PROXY_TARGET=${DLP_OPTION_PRICER_URL:-http://127.0.0.1:${DLP_OPTION_PRICER_PORT:-18081}}
FRONTEND_RPC_URL=${DLP_FRONTEND_RPC_URL:-$DLP_RPC_URL}
...

{
    ...
    printf 'VITE_OPTION_PRICER_BASE_URL=%s\n' "$OPTION_PRICER_URL"
    printf 'VITE_OPTION_PRICER_PROXY_TARGET=%s\n' "$OPTION_PRICER_PROXY_TARGET"
