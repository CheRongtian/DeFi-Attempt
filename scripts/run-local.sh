...
env -u DLP_OPERATOR_PRIVATE_KEY "$INDEXER_EXECUTABLE" --once
env -u DLP_OPERATOR_PRIVATE_KEY "$OUTBOX_EXECUTABLE" --once
env -u DLP_OPERATOR_PRIVATE_KEY "$OUTBOX_EXECUTABLE" &
OUTBOX_PID=$!
env -u DLP_OPERATOR_PRIVATE_KEY "$RISK_WORKER_EXECUTABLE" &
RISK_WORKER_PID=$!
"$TX_MANAGER_EXECUTABLE" &
TX_MANAGER_PID=$!
env -u DLP_OPERATOR_PRIVATE_KEY "$LIQUIDATOR_EXECUTABLE" &
LIQUIDATOR_PID=$!
env -u DLP_OPERATOR_PRIVATE_KEY "$API_EXECUTABLE" &
API_PID=$!
env -u DLP_OPERATOR_PRIVATE_KEY "$INDEXER_EXECUTABLE"
